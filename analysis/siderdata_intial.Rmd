...
mi_label1$ICD10_MI=icd_cui$ICD10[match(mi_label1$cui_mi, icd_cui$umls_medra)]
...
#mi_icd1=mi_icd1[c(3,5,6,7,8)]
#mi_icd1=mi_icd1[!duplicated(mi_icd1),]

se_mi=inner_join(se_icd, mi_label1, by='drugname')
...
##map se and mi both to icd and then remove matching
```
