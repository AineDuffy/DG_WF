...
allcat$pathString=paste("category",allcat$category, allcat$level2,allcat$PHECODE_SE,  sep = "/")
...
allcat_coloc$pathString=paste("category",allcat_coloc$category, allcat_coloc$level2,allcat_coloc$coloc08_phecode,  sep = "/")
