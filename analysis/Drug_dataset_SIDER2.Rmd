...
plt4=ggplot(meanoe, aes(x=mean_oe))+ geom_histogram(bins = 30, color="black", fill="light blue") +
  ...
  theme_classic()+
 geom_vline(aes(xintercept = mean(mean_oe, na.rm = T)),col='red',size=1) + annotate("text",color='red', x = 1, y = 50, label = paste('mean tau =', round(mean(meanoe$mean_oe, na.rm = T),2)))
