...
- Tau and OE score
``` {r, echo=F}
dataset=fread('/Users/aineduffy/Documents/PhD/DrugGenetics/Data/Dataset/drug_sider2_omim_tau_coloc_version3.txt',data.table=F)
head(dataset)
...
paste(length(matchsecoloc$phecode), 'phecodes are in unique coloc phecodes and se') #385
